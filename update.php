    ...
    <main>
        ...
        <form id="form" action="update_do.php" method="post">
            ...
            <div class="row mb-4">
                ...
                <input type="text" id ="task" name="task" class="form-control" placeholder="<?php print($task['task_name']); ?>">
                </div>

                <div class="col">
                <label for="target_time" class="form-label">目標時間</label>
                <input type="text" id ="target_time" name="target_time" class="form-control" placeholder="<?php print($task['target_time']); ?>">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col">
                <label for="created_at" class="form-label">開始日時</label>
                <input type="text" id ="created_at" name="created_at" class="form-control" placeholder="<?php print($task['created_at']); ?>">
                </div>

                <div class="col">
                <label for="finished_at" class="form-label">終了日時</label>
                <input type="text" id ="finished_at" name="finished_at" class="form-control" placeholder="<?php print($task['tfinished_at']); ?>">
                </div>
            </div>
            ...
            <div class="row mb-4">
                ...
                <input type="text" id ="duration" name="duration" class="form-control" placeholder="<?php print($task['duration']); ?>">
                </div>
            </div>
